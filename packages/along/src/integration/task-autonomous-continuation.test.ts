  ...
  planningMocks.readTaskPlanningSnapshot.mockReturnValue({
    ...
    data: makeSnapshot({
      task: {
        ...
        lifecycle: mockTaskConstants.LIFECYCLE.ACTIVE,
        currentWorkflowKind: mockTaskConstants.WORKFLOW_KIND.EXEC,
        commitShas: ['abc123'],
...
function makeSnapshot(
  ...
  return {
    task: {
      ...
      lifecycle: mockTaskConstants.LIFECYCLE.ACTIVE,
      currentWorkflowKind: mockTaskConstants.WORKFLOW_KIND.PLAN,
